...
export class CommandPost extends BuildingBase { readonly buildRadius = COMMANDPOST_BUILD_RADIUS; constructor(position: Vec2, team: Team) { super(EntityType.CommandPost, team, position, 2000, ENTITY_RADIUS.commandpost); this.powered = true; }
